...
* [Section 6: Independent Validation Batch effect analysis](#section-6-independent-validation-batch-effect-analysis)
    * [Section 6.1: Batch-effect assessment: PCA + regression on principal components](#section-61-batch-effect-assessment-pca--regression-on-principal-components)
    * [Section 6.2: Single-modality independent validation](#section-62-single-modality-independent-validation)
    * [Section 6.3: Multi-modality independent validation](#section-63-multi-modality-independent-validation)
